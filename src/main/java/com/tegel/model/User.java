...
public class User {
    ...
    public User(String email, String passwordHash, String phoneNumber, 
                LocalDate dateOfBirth, String dietRes, String fullName, String nickName) {
        this.email = email;
    ...
    public String getDietRes() { return dietRes; }
    public void setDietRes(String dietRes) { this.dietRes = dietRes; }
